...
<?php   }   ?>
  ...
  <textarea name="contenu_article"  class="form-control z-depth-1" id="exampleFormControlTextarea6" rows="3" placeholder="Contenu d'article"> <?php echo $_GET['contenu_article']  ?></textarea>
</div>
