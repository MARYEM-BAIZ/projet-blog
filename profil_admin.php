...
try {
    ...
    echo " la connexion a échoué " ." <br>";
         ...
         $select=$baseadminblog->prepare(' select * from utilisateur where id_utilisateur= ? and id_role=2 ');
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/profil_admin.css">
</head>
<body>
<header>
...
<main class="bg-white">
        ...
        <section class=" mt-5  mb-5 p-5">
           ...
           <tr>
            <th class=" border border-muted p-2">username</th>
            <td class=" border border-muted p-2"> <?php echo $afficher['username_utilisateur'] ;  ?></td>
            <td class=" border border-muted p-2"> <a href="modifier_profil.php?id=<?php echo $_SESSION['idutilisateur'] ?>&nom_utilisateur=<?php echo $afficher['username_utilisateur'] ?>&password_utilisateur=<?php echo $afficher['password_utilisateur'] ?>">modifier</a></td>
           </tr>

           <tr>
             <th class=" border border-muted p-2">email</th>
             <td class=" border border-muted p-2"> <?php echo $afficher['email_utilisateur'] ;  ?></td>
           </tr>

           <tr>
            <th class=" border border-muted p-2">mot de passe</th>
            <td class=" border border-muted p-2"> <?php echo $afficher['password_utilisateur'] ;  ?></td>
            <td class=" border border-muted p-2"> <a href="modifier_profil.php?id=<?php echo $_SESSION['idutilisateur'] ?>&nom_utilisateur=<?php echo $afficher['username_utilisateur'] ?>&password_utilisateur=<?php echo $afficher['password_utilisateur'] ?>">modifier</a></td>
            </tr>

            <tr>
            <th class=" border border-muted p-2">photo de profil</th>
            <td class=" border border-muted p-2"> <img style="width:150px ; height:150px ; border-radius: 70px ; border: none ; display:block ; margin-left:auto ;margin-right:auto  " src="<?php echo $afficher['avatar_utilisateur'] ;  ?>" alt="immage"></td>
            <td class=" border border-muted p-2"> <a href="modifier_profil.php?id=<?php echo $_SESSION['idutilisateur'] ?>&nom_utilisateur=<?php echo $afficher['username_utilisateur'] ?>&password_utilisateur=<?php echo $afficher['password_utilisateur'] ?>">modifier</a></td>
           </tr>
